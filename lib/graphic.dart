...
export 'src/variable/base.dart' show Variable;

export 'src/transform/base.dart' show Transform;
...
export 'src/axis/base.dart' show Tick, AxisLabel, GuideAxis;

export 'src/tooltip/base.dart' show Tooltip;
...
export 'src/event/gesture_arena.dart' show GestureEvent;
