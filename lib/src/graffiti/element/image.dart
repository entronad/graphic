...
class ImageElement extends BlockElement<ImageStyle> {
  ImageElement({
    ...
    paintPoint = getBlockPaintPoint(rotationAxis!, image.width.toDouble(), image.height.toDouble(), this.style.align ?? this.defaultAlign); // TODO: Image width height pixel ratio.
  }
